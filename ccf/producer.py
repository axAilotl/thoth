...
BATCH_FORMAT = "ccf.producer-batch/0.1.1"
...
class Producer:
    ...
    def new_record(
        ...
        *,
        ...
        self.schemas.validate(
            "urn:ccf:schema:0.1.1:submissions.record", submission, what="record submission"
        )
        return submission
    ...
    def new_link(
        ...
        *,
        ...
        self.schemas.validate(
            "urn:ccf:schema:0.1.1:submissions.link", submission, what="link submission"
        )
        return submission
    ...
    def new_blob(
        ...
        *,
        ...
        if origin is not None:
            submission["origin"] = origin
        self.schemas.validate(
            "urn:ccf:schema:0.1.1:submissions.blob", submission, what="blob submission"
        )
        ...
        *,
        ...
        with open_ccf_connection(self._settings) as conn:
            with conn.transaction():
                ...
                self.schemas.validate(
                    "urn:ccf:schema:0.1.1:sync.producer-batch",
                    batch,
                    what="producer batch",
                )
