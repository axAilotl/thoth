"""CCF 0.1.1 portable object envelopes (spec sections 3 and 5).
...
def compartment_format(object_kind: str, compartment: str) -> str:
    """Canonical compartment format label, e.g. ``ccf.record-structural/0.1.1``."""
    return f"ccf.{object_kind}-{compartment}/0.1.1"
