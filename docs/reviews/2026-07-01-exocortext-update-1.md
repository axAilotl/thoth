...
Historical report preserved from `branch-rationalization-2026-08-30` during the
2026-09-11 consolidation. Findings and line references describe the reviewed
branch, not current main; revalidate them before treating them as open issues.
