...
Historical report preserved from `fix/review-followups` during the 2026-09-11
branch consolidation. Findings and line references describe the reviewed branch,
not current main; revalidate them before treating them as open issues.
