# CCF 0.1.2 change log

0.1.2 is a narrow implementation-informed correction to 0.1.1. It does
...
- Suppression origin, stable-content, and scope derivations are separately
  registry-pinned; the scope vector uses the sorted object-ID array.
- Mindpacks declare first-class custody completeness and restore capability;
  the unsigned manifest is checked against independently derived contents.
...
- Authority, suppression, manifest-tamper, and implementation-informed
  conformance vectors.
