# Thoth → CCF 0.1.2-rc1 implementation checklist

> **Status annotation (2026-08-13, branch `ccf-0.1.2-rc1` @ merge `6527d8c`).**
...
> `scripts/ccf_scale.py`, `scripts/verify_ccf_012rc1_vectors.py`.
> Security review `SECURITY_REVIEW_CCF_0.1.2-rc1.md` findings H1, M1–M3,
...
- [x] Vendor this package under `spec/ccf/0.1.2-rc1/`. *(`0dab2e0`)*
...
- [x] Implement `ccf-jcs-sha256-v2` and reproduce every vector. *(`ccf/jcs.py`, `ccf/hashing.py`, `tests/test_ccf_hashing.py`, `scripts/verify_ccf_012rc1_vectors.py`)*
...
- [ ] Published vectors pass independently from the package generator. *(`scripts/verify_ccf_012rc1_vectors.py`; independent reproduction pending)*
