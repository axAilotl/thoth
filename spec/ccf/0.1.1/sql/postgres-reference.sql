-- CCF 0.1.1 — PostgreSQL reference operational envelope
...
CREATE TYPE ccf_batch_status AS ENUM ('queued', 'verifying', 'committed', 'partial', 'rejected', 'conflict');
...
CREATE TABLE ccf_origin_index (
    ...
    PRIMARY KEY (archive_id, source_id, native_id, revision)
);
...
-- Example when pgvector is installed:
-- CREATE TABLE projection_embedding (
--   object_id text NOT NULL,
